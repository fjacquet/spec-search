...
- Refreshed all three SPEC datasets from spec.org (results through Sep-2026):
  CPU2017 46,254 → 46,852 rows, CPU2026 279 → 469 rows, JBB2015 1,402 → 1,457
  rows. CSV schemas unchanged; MCP server's bundled gzipped copies regenerated.
